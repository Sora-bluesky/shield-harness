...
```mermaid
gantt
    title Clawless 開発スケジュール
    dateFormat YYYY-MM-DD
    axisFormat %m/%d

    section Core Security Harness
    REQUIREMENTS.md 作成 :done, task_001, 2026-03-21, 2026-03-21
    THREAT_MODEL.md 作成 :done, task_002, 2026-03-21, 2026-03-21
    ARCHITECTURE.md 作成 :done, task_003, 2026-03-21, 2026-03-21
